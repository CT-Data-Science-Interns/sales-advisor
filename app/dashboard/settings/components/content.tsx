...
const UserProfileCard: FC<Pick<UserSettingsPageData, "userProfile">> =
...
const LanguageTimeCard: FC<
  Pick<UserSettingsPageData, "languages" | "timezones" | "userSettings">
...
const SocialAccountsCard: FC<Pick<UserSettingsPageData, "userSettings">> =
...
const OtherAccountsCard: FC<Pick<UserSettingsPageData, "userSettings">> =
  function ({ userSettings }) {
...
const GeneralInformationCard: FC<Pick<UserSettingsPageData, "userProfile">> =
  function ({ userProfile }) {
    return (
      <Card>
        <h3 className="mb-4 text-xl font-bold dark:text-white">
...
const SessionsCard: FC<Pick<UserSettingsPageData, "userSettings">> = function ({
  userSettings,
}) {
  return (
    <Card>
...
const AlertsNotificationsCard: FC<Pick<UserSettingsPageData, "userSettings">> =
  function ({ userSettings }) {
    const [isCompanyNews, setCompanyNews] = useState(
      userSettings.alertsNotifications.companyNews
    );
    ...
    const [isNewMessages, setNewMessages] = useState(
      userSettings.alertsNotifications.newMessages
    );
...
const EmailNotificationsCard: FC<Pick<UserSettingsPageData, "userSettings">> =
  function ({ userSettings }) {
