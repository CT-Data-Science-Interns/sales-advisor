const StaticPageFooter = () => {
  return (
    <footer className="m-4 rounded-lg bg-white shadow dark:bg-gray-800">
      <div className="mx-auto mr-40 w-full max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
        ...
        <ul className="mt-3 flex flex-wrap items-center text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
          ...
          <li>
            <a href="/bug-report" className="me-4 hover:underline md:me-6">
              Report
            </a>
          </li>
          <li>
