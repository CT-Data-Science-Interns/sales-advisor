    ...
    <footer className="bg-white dark:bg-gray-800">
      <div className="mx-auto max-w-screen-xl p-4 sm:p-8 lg:p-10">
        ...
        <div className="flex flex-col items-center justify-between text-center lg:flex-row">
          <a
            href="#"
            className="mb-6 flex items-center text-2xl font-semibold text-gray-900 dark:text-white lg:mb-0"
          >
            <svg
              className="mr-2 h-8"
              viewBox="0 0 33 33"
          ...
          <span className="mb-6 block text-sm text-gray-500 dark:text-gray-400 lg:mb-0">
            © 2021-2022{" "}
            <a href="#" className="hover:underline">
              Flowbite™
            </a>
          ...
          <button
            ...
            className="mt-3 inline-flex items-center text-center text-sm font-medium text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white sm:mt-0"
            type="button"
          >
            <svg
          ...
          <div
            id="dropdown"
            className="z-10 hidden w-44 divide-y divide-gray-100 rounded bg-white text-left shadow dark:bg-gray-700"
            data-popper-placement="bottom"
            style={{
              position: "absolute",
              inset: "0px auto auto 0px",
              margin: "0px",
              transform: "translate3d(911px, 681.5px, 0px)",
            }}
          >
            <ul
