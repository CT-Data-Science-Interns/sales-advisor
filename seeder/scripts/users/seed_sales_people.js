...
var filePath = '../../raw_data/sales_people_v2.csv';
// Read the csv file.
var data = '';
try {
...
var salesPeople = columns.map(function (column) {
...
var SALES_PERSON_UUID = 'f83f0d9cb57849c78276';
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                _a.label = 1;
            case 1:
                if (!(i < salesPeople.length)) return [3 /*break*/, 12];
                console.log("Processing #".concat(i + 1, " ").concat(salesPeople[i].email, "..."));
                console.log('Signing in user...');
                userUUID = void 0;
                return [4 /*yield*/, signInUser(salesPeople[i].email, salesPeople[i].password)];
            case 2:
                // Check if user exists. If not, create user.
                userUUID = _a.sent();
                if (!(userUUID === null)) return [3 /*break*/, 4];
                console.log('User does not exist. Creating user...');
                return [4 /*yield*/, createUser(salesPeople[i].email, salesPeople[i].password)];
            case 3:
                userUUID = _a.sent();
                if (userUUID === null) {
            ...
            case 4:
                ...
                q = (0, firestore_1.query)((0, firestore_1.collection)(db, 'usersEmailAddresses'), (0, firestore_1.where)('email', '==', salesPeople[i].email));
                return [4 /*yield*/, (0, firestore_1.getDocs)(q)];
            case 5:
                querySnapshot = _a.sent();
                if (!querySnapshot.empty) return [3 /*break*/, 7];
                return [4 /*yield*/, addUserEmailAddress(userUUID, salesPeople[i].email)];
            case 6:
